...
Para ter acesso as funcionalidades de lista de compras
    ...
    Scenario: Cadastro com nome pequeno
    ...
    Scenario: Cadastro com email já cadastrado
        ...
        Then visualizo mensagem de duplicidade "Este e-mail já é utilizado por outro usuário."
        And visualizo a mensagem no response body "User already exists"
    ...
    Scenario: Cadastro com email maior que 60 caracteres
        ...
        Then visualizo mensagem para corrigir tamanho de email "Informe no máximo 60 caracteres."
